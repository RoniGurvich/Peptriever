...
cd "$BINDING_DATA_DIR" && wget "http://wnl.cs.hongik.ac.kr/yapp/download/yappcdann.csv"
cd "$BINDING_DATA_DIR" && wget "http://wnl.cs.hongik.ac.kr/yapp/download/protein.tar.gz"
cd "$BINDING_DATA_DIR" && tar xzvf ./protein.tar.gz
cd "$BINDING_DATA_DIR" && wget "http://wnl.cs.hongik.ac.kr/yapp/download/peptide.tar.gz"
cd "$BINDING_DATA_DIR" && tar xzvf ./peptide.tar.gz
